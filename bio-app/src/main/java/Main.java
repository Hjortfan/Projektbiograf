...
public class Main {
	 ...
	 * 
	 * @param sql	sqlConnector.	Object of the class that connects to the 
	 * 								MySql database.
	 */
	 ...
	 * 
	 * for now it also contains a system.out.print method to test the connection to the
	 * database
	 * 
	 * @param args
	 */
    ...
    /**
     * Method used for sending the client the web page corresponding to the path the client has requested.
     * 
     * @param htmlFile	String.	HTML file for the path the client has requested.
     * 
     * @return String(Files.readAllBytes(path), Charset.defaultCharset()); or null.
     */
